...
<head>
  ...
  <title>DOCTOR BAG CHIC | Flagship Atelier</title>
  <meta name="description" content="Discover Doctor Bag Chic at 181 Mercer Street, NYC. Dedicated to Haute Leathercraft & Bespoke Structured Doctor Bags and artisanal excellence.">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Syne:wght@500;600;700;800&family=Space+Grotesk:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap">
  <link rel="stylesheet" href="assets/css/style.css">
</head>
<body>
<header class="site-header">
  <div class="container header-inner">
    <a href="index.php" class="brand-logo">DOCTOR BAG CHIC</a>
...
<div class="mobile-drawer" id="mobile-drawer">
  <div class="drawer-header">
    <span class="brand-logo">DOCTOR BAG CHIC</span>
  ...
  <section class="hero" style="border-bottom:1px solid var(--border-subtle); background:radial-gradient(circle at 80% 20%, #1c1c20 0%, #08080a 70%);">
    <div class="container" style="display:grid; grid-template-columns:1.2fr 0.8fr; gap:3.5rem; align-items:center;">
      <div>
        <div style="display:inline-flex; align-items:center; gap:0.5rem; background:var(--bg-surface); padding:0.4rem 0.9rem; border-radius:var(--radius-sm); border:1px solid var(--border-subtle); margin-bottom:1.25rem;">
          <span style="width:8px; height:8px; border-radius:50%; background:var(--accent-gold); display:inline-block;"></span>
          <span style="font-family:var(--font-mono); font-size:0.8rem; color:var(--text-secondary); text-transform:uppercase; letter-spacing:0.08em;">Haute Leathercraft &bull; 181 Mercer Atelier</span>
        </div>
        <h1 style="font-size:3.4rem; line-height:1.12; letter-spacing:-0.02em; margin-bottom:1.5rem;">Structured Doctor Bags & Bespoke Leathercraft</h1>
        <p style="font-size:1.15rem; color:var(--text-secondary); max-width:620px; line-height:1.75; margin-bottom:2.25rem;">Mastercrafted from French boxcalf and hand-burnished bridle leather with hinged brass frame closures at 181 Mercer Street. Merging venerable medical satchel silhouettes with avant-garde architectural maroquinerie.</p>
        <div style="display:flex; gap:1.25rem; align-items:center; flex-wrap:wrap;">
          <a href="services.html" class="btn-primary">Explore Leather Collections</a>
          <a href="about.html" class="btn-secondary">Atelier Craftsmanship</a>
        </div>
        <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:1.5rem; margin-top:3rem; padding-top:2rem; border-top:1px solid var(--border-subtle);">
          <div>
            <div style="font-family:var(--font-mono); font-size:1.6rem; font-weight:700; color:var(--accent-gold);">100%</div>
            <div style="font-size:0.8rem; color:var(--text-muted); text-transform:uppercase; letter-spacing:0.05em; margin-top:0.25rem;">Saddle Stitched</div>
          </div>
          <div>
            <div style="font-family:var(--font-mono); font-size:1.6rem; font-weight:700; color:var(--accent-gold);">0.05mm</div>
            <div style="font-size:0.8rem; color:var(--text-muted); text-transform:uppercase; letter-spacing:0.05em; margin-top:0.25rem;">Bevel Tolerance</div>
          </div>
          <div>
            <div style="font-family:var(--font-mono); font-size:1.6rem; font-weight:700; color:var(--accent-gold);">NYC</div>
            <div style="font-size:0.8rem; color:var(--text-muted); text-transform:uppercase; letter-spacing:0.05em; margin-top:0.25rem;">SoHo Atelier</div>
          </div>
        </div>
      </div>
  ...
  <section class="section-pad">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Tailored commissions engineered for connoisseurs of Haute Leathercraft & Bespoke Structured Doctor Bags.</p>
      </div>
      <div class="grid-2">
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container" style="display:grid; grid-template-columns:1fr 1.1fr; gap:4rem; align-items:center;">
      ...
      <div>
        ...
        <p style="color:var(--text-secondary); line-height:1.8; margin-bottom:1.5rem;">Since our founding at 181 Mercer Street, Doctor Bag Chic has stood as a bastion of tactile discipline. While commercial entities pursue automated shortcuts, our workshop remains committed to the slow, meditative cadence of traditional hand finishing.</p>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Our Flagship Atelier (DOCTOR BAG CHIC)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Unsolicited feedback from patrons who demand uncompromised excellence in Haute Leathercraft & Bespoke Structured Doctor Bags.</p>
      </div>
      <div class="grid-3">
        <div class="quote-card">
          <p class="quote-text">"The bespoke execution delivered by Doctor Bag Chic is extraordinary. The tactile feel and flawless balance prove their unwavering adherence to classical hand methods."</p>
...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-bottom">
      <span>&copy; 2026 DOCTOR BAG CHIC. All rights reserved. Certified Handcrafted Static Architecture.</span>
